        ...
        <div class="d-flex justify-content-center position-absolute w-100" style="bottom: 20px; z-index: 10; gap: 10px;">
            @foreach ($sliders as $index => $slider)
                <button type="button" data-bs-target="#heroCarousel" data-bs-slide-to="{{ $index }}"
                    ...
                    @if ($slider->image)
                        <img src="{{ asset('public/storage/' . $slider->image) }}" alt="{{ $slider->title }}"
        ...
        <div class="carousel-inner">
            @foreach ($sliders as $index => $slider)
                <div class="carousel-item {{ $index === 0 ? 'active' : '' }}"
                    style="background-image: url('{{ $slider->image ? asset('public/storage/' . $slider->image) : '' }}');">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-md-6 wow fadeInUp"
                                                ...
                                                <div class="product-store-item">
                                                    <div class="product-image">
                                                        <img src="{{ $product->main_image ? asset('public/storage/' . $product->main_image) : asset('assets/img/generated images/bags2.png') }}"
                                                            alt="{{ $product->name }}"
                                            ...
                                            <div class="swiper-slide">
                                                <div class="shop-discover-item wow fadeInUp"
                                                    ...
                                                    <div class="shop-image">
                                                        <img src="{{ $product->main_image ? asset('public/storage/' . $product->main_image) : asset('assets/img/product/9.png') }}"
                                                            alt="{{ $product->title }}">
                                                    </div>
                                                    <div class="content">
                                                        <div class="star">
                            ...
                            <div class="col-lg-6 wow fadeInRight" data-wow-delay=".6s">
                                ...
                                @if ($bannerProduct)
                                    <div class="bg-image-2 bg-cover"
                                        style="background-image: url('{{ $bannerProduct->main_image ? asset('public/storage/' . $bannerProduct->main_image) : asset('assets/img/product/1.png') }}');">
