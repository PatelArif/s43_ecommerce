                    ...
                    <div class="shop-details-image d-flex">
                        ...
                        <ul class="nav flex-column me-3 thumb-list">
                            ...
                            <li class="nav-item mb-2">
                                <a href="#thumb{{ $index + 1 }}" data-bs-toggle="tab" class="nav-link {{ $index == 0 ? 'active' : '' }}">
                        ...
                        <div class="tab-content flex-grow-1">
                            @foreach (['main_image', 'image_1', 'image_2', 'image_3', 'image_4'] as $index => $img)
                            <div id="thumb{{ $index + 1 }}" class="tab-pane fade {{ $index == 0 ? 'show active' : '' }}">
...
<section class="single-tab-section section-padding fix pt-0">
    <div class="container">
        <div class="single-tab">
            <ul class="nav mb-5">
                <li class="nav-item"><a href="#description" data-bs-toggle="tab" class="nav-link ps-0 active"><h6>Description</h6></a></li>
                <li class="nav-item"><a href="#additional" data-bs-toggle="tab" class="nav-link"><h6>Additional Information</h6></a></li>
                <li class="nav-item"><a href="#review" data-bs-toggle="tab" class="nav-link"><h6>Reviews (2)</h6></a></li>
            </ul>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-5 mt-lg-0">
                                <div class="description-image">
                                    <img src="{{ $product->main_image ? asset('storage/' . $product->main_image) : asset('assets/img/product/9.png') }}" class="img-fluid" alt="{{ $product->title }}">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div id="additional" class="tab-pane fade">
                    <div class="table-responsive">
                        <table class="table table-bordered">
                            <tbody>
                                <tr><td>Height</td><td>{{ $product->height }}</td></tr>
                                <tr><td>Width</td><td>{{ $product->width }}</td></tr>
                                <tr><td>Handle</td><td>{{ $product->handle }}</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
