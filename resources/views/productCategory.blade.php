                                ...
                                <div class="col-lg-6">
                                    <div class="product-details-content">
                                        ...
                                        <div class="cart-wrp">
                                            ...
                                            <a href="{{ url('allBags/' . $slug . '/jute') }}" class="icon">
                                        ...
                                        <div class="shop-btn">
                                            ...
                                            <a href="{{ url('allBags/' . $slug . '/jute') }}" class="theme-btn">
                                                <span> Buy now</span>
                                            </a>
                                        </div>
                                        <h6 class="details-info"><span>SKU:</span> <a href="{{ url('allBags/' . $slug . '/jute') }}">124224</a></h6>
                                        <h6 class="details-info"><span>Categories:</span> <a href="{{ url('allBags/' . $slug . '/jute') }}">Crux Indoor Fast and Easy</a></h6>
                                        <h6 class="details-info style-2"><span>Tags:</span> <a href="{{ url('allBags/' . $slug . '/jute') }}"> <b>accessories</b> <b>business</b></a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="product-details-item">
                                        <div class="shop-image">
                                            ...
                                            <ul class="shop-icon d-grid justify-content-center align-items-center">
                                                <li>
                                                    <a href="{{ url('allBags/' . $slug . '/jute') }}"><i class="fa-regular fa-cart-shopping"></i></a>
                                                </li>
                                                <li>
                                        ...
                                        <div class="content">
                                            ...
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Whitetails Women's Open Sky</a>
                                            </h4>
                                            <div class="star">
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            <p>Backpack, Wonder</p>
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Simple Modern School Boys</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            <p>Shoe, Men's</p>
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Women's Essentials Convertible</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            <p>Bag, Wonder</p>
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Calvin Klein Gabrianna Novelty</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            ...
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Govicta Men's Shoes Leather</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            <p>Bag, Wonder</p>
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Tommy Hilfiger Women’s Jaden</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            <p>Whitetails Store</p>
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Legendary Whitetails Men's.</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                ...
                                <div class="col-xl-3 col-lg-6 col-md-6">
                                    <div class="product-details-item">
                                        ...
                                        <div class="content">
                                            <p>Backpack, School Bag</p>
                                            <h4>
                                                <a href="{{ url('allBags/' . $slug . '/jute') }}">Backpack, School, Travel</a>
                                            </h4>
                                            <div class="star">
                                                <i class="fa-solid fa-star"></i>
                                                <i class="fa-solid fa-star"></i>
                                    ...
                                    <div class="col-xl-12">
                                        ...
                                        <div class="product-details-item style-2">
                                            ...
                                            <div class="content">
                                                <p>Whitetails Store</p>
                                                <h3>
                                                    <a href="{{ url('allBags/' . $slug . '/jute') }}">Backpack, School Bag</a>
                                                </h3>
                                                <div class="star">
                                                    <i class="fa-solid fa-star"></i>
                                                    <i class="fa-solid fa-star"></i>
