...
// Route to fetch a product for editing
    ...
    Route::post('/orders/{id}/ready', [OrderController::class, 'markReady'])->name('admin.orders.ready');
    Route::post('/orders/{id}/dispatch', [OrderController::class, 'dispatch'])->name('admin.orders.dispatch');
