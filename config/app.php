...
return [
    ...
    */
    ...
    'timezone'        => 'Asia/Kolkata', // Adjusted to India Standard Time (IST)
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | These are the service providers that will be loaded on every request to
    | your application. You can add custom service providers here.
    |
    */
